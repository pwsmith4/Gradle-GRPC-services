...
Video link: https://youtu.be/pXoANKY9jw0 
...
gradle runNode and gradle runClient are how to run the main code. You can run gradle runClient -Pauto=1 to auto run code.
